...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_promise_polyfill__ = __webpack_require__("./node_modules/promise-polyfill/promise.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__interceptor_auth__ = __webpack_require__("./resources/assets/js/interceptor/auth.js");
...
window.axios.interceptors.request.use(__WEBPACK_IMPORTED_MODULE_1__interceptor_auth__["a" /* default */].request, __WEBPACK_IMPORTED_MODULE_1__interceptor_auth__["a" /* default */].requestError);

window.axios.interceptors.response.use(__WEBPACK_IMPORTED_MODULE_1__interceptor_auth__["a" /* default */].response, __WEBPACK_IMPORTED_MODULE_1__interceptor_auth__["a" /* default */].responseError);

/***/ }),

/***/ "./resources/assets/js/interceptor/auth.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise__ = __webpack_require__("./node_modules/babel-runtime/core-js/promise.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_auth__ = __webpack_require__("./resources/assets/js/api/auth.js");
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    response: function response(_response) {
        if (_response.status && _response.status == 401) {
            __WEBPACK_IMPORTED_MODULE_1__api_auth__["a" /* default */].logout();
        }
...
Vue.component('select2', {
    ...
    mounted: function mounted() {
        ...
        var settings = $.extend({}, { data: this.options }, this.settings);
        $(this.$el).select2(settings).val(this.value).trigger('change').on('change', function () {
...
var app = new Vue({
    ...
    watch: {
        results: function results(value) {
            if (!value.length) {
                this.resetForm();
            }
        }
    ...
    methods: {
        search: function search() {
            ...
            this.searching = true;
            axios.post('/_admin/locator/search', this.form).then(function (_ref) {
                var data = _ref.data;

                _this.searching = false;
                _this.hasResult = true;
                _this.results = data.map(function (item) {
                    item.categories = _this.form.categories;
                    item.city_id = _this.form.city_id;
                    item.area = _this.form.area;
                    item.saving = false;
                    return item;
                });
            }).catch(function (error) {
        ...
        saveAll: function saveAll() {
            ...
            this.saving = true;
            axios.post('/_admin/locator/all', { 'venues': this.results }).then(function (_ref2) {
                var data = _ref2.data;
        ...
        save: function save(index) {
            ...
            data.saving = true;
            axios.post('/_admin/locator', data).then(function () {
                data.saving = false;
                _this3.results.splice(index, 1);
                if (!_this3.results.length) {
                    _this3.hasResult = false;
                }
            }).catch(function (error) {
                data.saving = false;
                console.log(error);
