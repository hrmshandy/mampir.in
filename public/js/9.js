...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vee_validate__ = __webpack_require__("./node_modules/vee-validate/dist/vee-validate.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            validator: new __WEBPACK_IMPORTED_MODULE_1_vee_validate__["Validator"]({
    ...
    methods: {
        ...
        submit: function submit() {
            this.validator.validateAll({ email_operator: this.dataMerchant.email_operator, password_operator: this.dataMerchant.password_operator }).then(function (result) {
                if (!result) {
                    return;
                }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.dataMerchant.email_operator),
      expression: "dataMerchant.email_operator"
    }],
    staticClass: "o-input",
    attrs: {
      "type": "text",
    ...
    on: {
      "input": function($event) {
        ...
        _vm.dataMerchant.email_operator = $event.target.value
      }
    }
  }), _vm._v(" "), (_vm.validator.errors.has('email_operator')) ? _c('span', {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.dataMerchant.password_operator),
      expression: "dataMerchant.password_operator"
    }],
    staticClass: "o-input",
    attrs: {
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.dataMerchant.password_operator = $event.target.value
      }
    }
  }), _vm._v(" "), (_vm.validator.errors.has('password_operator')) ? _c('span', {
    staticClass: "c-form-feedback c-form-feedback__merchant"
