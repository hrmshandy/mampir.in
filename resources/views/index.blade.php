...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ url('/images//faviconfavicon-32x32.png') }}">
    <link rel="icon" type="image/png" sizes="96x96" href="{{ url('/images//faviconfavicon-96x96.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ url('/images//faviconfavicon-16x16.png') }}">
    <link rel="manifest" href="{{ url('/images//faviconmanifest.json') }}">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="{{ url('/imagesfavicon//ms-icon-144x144.png') }}">
    {{-- Favicon --}}
