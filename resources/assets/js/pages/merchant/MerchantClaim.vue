    ...
    <div class="o-section claim-merchant">
        <div class="o-container">
            ...
            <div class="u-text-center" v-if="(results.length > 0) && (pages > 1)">
                <ul class="pagination">
                    ...
                    <li v-for="page in pages">
                        <a href="#" @click.prevent="goToPage(page)" :class="{'is-current': currentPage == page}">{{ page
                            }}</a>
                    </li>
                    <li>
            ...
            <div v-if="searching" class="c-result__notfound u-text-center">
                ...
                <router-link to="/merchant/registration/1"
                             class="o-button o-button--primary o-button--mincontent o-button--large">Tambah Merchant
                </router-link>
            </div>
        </div>
    </div>
